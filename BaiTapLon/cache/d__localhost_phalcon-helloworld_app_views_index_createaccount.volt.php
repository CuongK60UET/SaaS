...
<div id="main">
    <div class="container login-container">
        <div class="form-container" >
            <form action="../index/createAccount" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" id="inputEmail" placeholder="Your address">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" id="inputEmail" placeholder="Your Username or Email">
                    </div>
                </div>
                <div class="form-group">
